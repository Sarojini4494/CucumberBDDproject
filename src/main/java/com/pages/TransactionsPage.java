...
//last 90days behind    
      ...
      driver.findElement(By.xpath("//*[@id=\"app-site\"]/div/div[1]/div[3]/div/header/div/ul/li[3]/div/div/div/span[3]")).click();        
       ...
       /***public void countandvolumetally() throws InterruptedException {
          ...
          /* WebElement volcount =driver.findElement(By.xpath("//*[@id=\"app-site\"]/div/div[1]/div[3]/main/div/div[1]/div[1]/div/div[1]/div/div[2]/div/div/p"));
           String text = volcount.getAttribute("innerHTML");
           System.out.println(text);



           WebElement count =driver.findElement(By.xpath("//span[contains(text(),'Swipe Amount: $')]"));
           String textt = count.getAttribute("innerHTML");
           System.out.println(textt);
       }*/
